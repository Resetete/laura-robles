...
ActiveRecord::Schema[7.0].define(version: 2023_09_15_095302) do
  ...
  create_table "imprint_contents", force: :cascade do |t|
    t.string "name"
    t.string "phone"
    t.string "email"
    t.string "address"
  ...
  create_table "video_player_contents", force: :cascade do |t|
    t.string "video_url"
    t.enum "instrument", null: false, enum_type: "video_instrument"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
