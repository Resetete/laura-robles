...
module AdminHelper
  ...
  def delete_button(main_path, object)
    ...
    button_to(t('buttons.destroy'), public_send("destroy_#{main_path}s_path", id: object, locale: I18n.locale),
              method: :delete, data: { "turbo-method": :delete, turbo_confirm: 'Are you sure you want to delete?' }, class: 'btn btn-danger')
  end
